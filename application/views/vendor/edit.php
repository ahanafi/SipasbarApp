      ...
      <section class="col-lg-12">
        <!-- Custom tabs (Charts with tabs)-->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('dashboard/vendor/update/'.$vdr->vid); ?>" class="form-horizontal" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputCompanyName3" class="col-sm-2 control-label">Perusahaan</label>
                  <div class="col-sm-10">
                    <input type="text" name="perusahaan" class="form-control" id="inputCompanyName3" placeholder="Perusahaan" value="<?php echo $vdr->perusahaan; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="telp" class="form-control" id="inputTelp3" placeholder="Nomor Telepon" value="<?php echo $vdr->telp; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea name="alamat" class="form-control" rows="3" id="inputAlamat3" style="resize: none;" placeholder="Alamat"><?php echo $vdr->alamat; ?></textarea>
